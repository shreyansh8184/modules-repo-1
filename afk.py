...
class AFKMod(loader.Module):
    ...
    async def afkcmd(self, message):
        ...
        await message.edit(_("<b>Ma owner's goin' AFK</b>"))
    ...
    async def unafkcmd(self, message):
        ...
        await message.edit(_("<b>My owner's no longer AFK</b>"))
    ...
    async def watcher(self, message):
        if message.mentioned or getattr(message.to_id, 'user_id', None) == self._me.id:
            ...
            if user.is_self or user.bot or user.verified:
                ...
                afkreason = f"<b>{utils.escape_html(self.get_afk())}</b>"
                ...
                while hours >= 24:
                    hours -= 24
                    pass
                afktime = "<b>My owner has been afk for " + str(years) + " years " + str(months) + " months " + str(days)
                ...
                if seconds == 0:
                    ...
                    pass
                reply = "<b>My owner is afk right now. \nReason:</b><i> " + afkreason + "</i><b>\n\n" + afktime + "</b>"
